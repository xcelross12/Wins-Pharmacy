...
Public Class rptSeniorDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WinsPharmacy.rptSeniorDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSeniorDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSeniorDetails = New rptSeniorDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
