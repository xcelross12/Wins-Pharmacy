...
Public Class rptDeliverHistory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WinsPharmacy.rptDeliverHistory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDeliverHistory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDeliverHistory = New rptDeliverHistory()
        rpt.Site = Me.Site
        Return rpt
    End Function
