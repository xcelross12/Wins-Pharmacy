...
Public Class rptPurchases
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WinsPharmacy.rptPurchases.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPurchases
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPurchases = New rptPurchases()
        rpt.Site = Me.Site
        Return rpt
    End Function
